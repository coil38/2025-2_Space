...
public class TestUI : MonoBehaviour
{
    ...
    protected void OnEnable()
    {
        if (s_RebindActionUIs == null)
            s_RebindActionUIs = new List<TestUI>();
    ...
    private static List<TestUI> s_RebindActionUIs;
    ...
    [Serializable]
    public class UpdateBindingUIEvent : UnityEvent<TestUI, string, string, string>
    {
    }

    [Serializable]
    public class InteractiveRebindEvent : UnityEvent<TestUI, InputActionRebindingExtensions.RebindingOperation>
    {
    }
}
