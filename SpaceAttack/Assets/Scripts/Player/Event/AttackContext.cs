...
public class AttackContext
{
    ...
    public AttackContext(GameObject target, float damageRate, Vector3 attackDir, ChipAttackType type, float a_rateSume, float d_rateSume, float w_d_rateSume, float s_d_rateSume)
    {
        this.target = target;
