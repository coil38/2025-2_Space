...
public class GameSceneManager : MonoBehaviour
{
    ...
    private SceneType GetSceneType(Scene scene)
    {
        switch (scene.name)
        {
            ...
            case "BattleTestNormalScene":             //발표용 씬으로 임시 변경. 원래 : BattleTestNormalScene
                LogUtil.Log("전투씬");
    ...
    public static string GetSceneNameByType(SceneType type)
    {
        switch (type)
        {
            ...
            case SceneType.BattleScene: return "BattleTestNormalScene";            //발표용 씬으로 임시 변경. 원래 : BattleTestNormalScene
